...
export default {
  ...
  data() {
    return {
      excelData: [],
      newOwnerName : "IC-Distributor-2",
      newOwnerMSPID : "IC-Distributor-2-MSPID"
    };
  },
  methods: {
    ...
    async submitFile(){
      ...
      var response = await PostsService.sellAsset(this.excelData, this.newOwnerName, this.newOwnerMSPID, "IC-Distributor-1");
