...
export default {
  ...
  data() {
    return {
      excelData: [],
      newOwnerName : "SystemDistributor",
      newOwnerMSPID : "SystemDistributorMSPID"
    };
  },
  methods: {
    ...
    async submitFile(){
      ...
      var response = await PostsService.sellAsset(this.excelData, this.newOwnerName, this.newOwnerMSPID, "System-Integrator");
