...
export default {
  ...
  data() {
    return {
      excelData: [],
      newOwnerName : "PCB-Assembler",
      newOwnerMSPID : "PCB-Assembler-MSPID"
    };
  },
  methods: {
    ...
    async submitFile(){
      ...
      var response = await PostsService.sellAsset(this.excelData, this.newOwnerName, this.newOwnerMSPID, "IC-Distributor-2");
