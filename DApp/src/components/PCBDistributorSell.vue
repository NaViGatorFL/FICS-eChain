...
export default {
  ...
  data() {
    return {
      excelData: [],
      newOwnerName : "SystemIntegrator",
      newOwnerMSPID : "SystemIntegratorMSPID"
    };
  },
  methods: {
    ...
    async submitFile(){
      ...
      var response = await PostsService.sellAsset(this.excelData, this.newOwnerName, this.newOwnerMSPID, "PCB-Distributor");
