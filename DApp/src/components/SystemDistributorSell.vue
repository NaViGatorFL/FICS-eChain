...
export default {
  ...
  data() {
    return {
      excelData: [],
      newOwnerName : "EndUser",
      newOwnerMSPID : "EndUserMSPID"
    };
  },
  methods: {
    ...
    async submitFile(){
      ...
      var response = await PostsService.sellAsset(this.excelData, this.newOwnerName, this.newOwnerMSPID, "System-Distributor");
