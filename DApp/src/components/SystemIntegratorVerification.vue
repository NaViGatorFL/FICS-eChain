...
async function getChallenge(r) {
  ...
  let variable = await PostsService.getChallenge(ecid, "System-Integrator");
  ...
  methods: {
    ...
    */
    ...
    async verifyPUFResponse() {
      ...
      let response;
      response = await PostsService.pufVerify(ecidValue,challengeValue,generatedResponse,"System-Integrator");
    ...
    async submitFile() {
      ...
      */
      let printString;
      printString = await PostsService.verifyOnLedger(this.excelData, "System-Integrator");
